...
typedef struct
CBOR_Spec_Raw_Base_raw_uint64_s
{
  uint8_t size;
  uint64_t value;
}
...
Pulse_Lib_Slice_slice__uint8_t_s
{
  uint8_t *elt;
  size_t len;
}
...
#define FStar_Pervasives_Native_None 1
#define FStar_Pervasives_Native_Some 0
...
typedef struct
__attribute__((annotate("scylla_adt")))
__attribute__((annotate("scylla_empty_variant(cbor_raw_None)")))
FStar_Pervasives_Native_option__CBOR_Pulse_Raw_Type_cbor_raw_s
{
  FStar_Pervasives_Native_option__LowParse_Pulse_Base_with_perm__CBOR_Pulse_Raw_Type_cbor_raw__tags
  tag;
  union { cbor_raw v };
