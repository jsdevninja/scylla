      ...
      name_map :=
        FileMap.update name
          (function
            ...
            | Some _ ->
                Format.printf
                  "Declaration %s appears twice in translation unit, found again in %s\n@." name
                  filename;
                Some path)
          !name_map
  | Var vdecl ->
      let t =
        try translate_typ vdecl.var_type
        with _ ->
