...
pub fn Hacl_Bignum4096_mul(a: &[u64], b: &[u64], res: &mut [u64])
{
  ...
  crate::hacl::bignum::Hacl_Bignum_Karatsuba_bn_karatsuba_mul_uint64(64u32, a, b, tmp, res)
}

pub fn Hacl_Bignum4096_sqr(a: &[u64], res: &mut [u64])
{
  let mut tmp: [u64; 256] = [0u64; 256usize];
  crate::hacl::bignum::Hacl_Bignum_Karatsuba_bn_karatsuba_sqr_uint64(64u32, a, tmp, res)
}
...
#[inline] pub fn areduction(n: &[u64], nInv: u64, c: &mut [u64], res: &mut [u64])
{
  ...
  let c00: u64 = c0;
  let mut tmp: [u64; 64] = [0u64; 64usize];
  let c1: u64 = Hacl_Bignum4096_sub(res, n, tmp);
  crate::lowstar::ignore::ignore::<u64>(c1);
...
)
{
  if bBits < 200u32
  {
    ...
    from(ctx_r2.0, mu, ctx_r2.1, resM);
    ...
    for i in 0u32..bBits
    {
      ...
      if bit != 0u64
      {
        ...
        amont_mul(ctx_n.1, mu, aM_copy, aM, resM);
        crate::lowstar::ignore::ignore::<&[u64]>(ctx)
      };
      let mut aM_copy: [u64; 64] = [0u64; 64usize];
      (aM_copy[0usize..64usize]).copy_from_slice(&aM[0usize..64usize]);
      let ctx_n: (&[u64], &[u64]) = ctx.split_at(0usize);
      amont_sqr(ctx_n.1, mu, aM_copy, aM);
      crate::lowstar::ignore::ignore::<&[u64]>(ctx)
    };
    from(n, mu, resM, res);
    return ()
  ...
  for i in 0u32..7u32
  {
    ...
    amont_sqr(ctx_n1.1, mu, aM_copy0, tmp);
    crate::lowstar::ignore::ignore::<&[u64]>(ctx);
    ...
    (aM_copy[0usize..64usize]).copy_from_slice(&aM[0usize..64usize]);
    let ctx_n: (&[u64], &[u64]) = ctx.split_at(0usize);
    amont_mul(ctx_n.1, mu, aM_copy, t2.1, tmp);
    crate::lowstar::ignore::ignore::<&[u64]>(ctx);
  ...
  if bBits.wrapping_rem(4u32) != 0u32
  {
    ...
    (resM[0usize..64usize]).copy_from_slice(&(a_bits_l.1 as &[u64])[0usize..64usize])
  }
  else
  {
    let ctx_n: (&[u64], &[u64]) = ctx.split_at(0usize);
  ...
  for i in 0u32..bBits.wrapping_div(4u32)
  {
    for i0 in 0u32..4u32
    {
      ...
      (aM_copy[0usize..64usize]).copy_from_slice(&resM[0usize..64usize]);
      let ctx_n: (&[u64], &[u64]) = ctx.split_at(0usize);
      amont_sqr(ctx_n.1, mu, aM_copy, resM);
      crate::lowstar::ignore::ignore::<&[u64]>(ctx)
    };
    let k: u32 =
    ...
    let a_bits_l: (&[u64], &[u64]) = table.split_at(bits_l32.wrapping_mul(64u32) as usize);
    (tmp0[0usize..64usize]).copy_from_slice(&(a_bits_l.1 as &[u64])[0usize..64usize]);
    let mut aM_copy: [u64; 64] = [0u64; 64usize];
    (aM_copy[0usize..64usize]).copy_from_slice(&resM[0usize..64usize]);
    let ctx_n: (&[u64], &[u64]) = ctx.split_at(0usize);
    amont_mul(ctx_n.1, mu, aM_copy, tmp0, resM);
    crate::lowstar::ignore::ignore::<&[u64]>(ctx)
  };
  from(n, mu, resM, res)
}
...
)
{
  if bBits < 200u32
  {
    ...
    for i0 in 0u32..bBits
    {
      ...
      (aM_copy[0usize..64usize]).copy_from_slice(&aM[0usize..64usize]);
      let ctx_n1: (&[u64], &[u64]) = ctx.split_at(0usize);
      amont_mul(ctx_n1.1, mu, aM_copy, resM, aM);
      crate::lowstar::ignore::ignore::<&[u64]>(ctx);
      let mut aM_copy0: [u64; 64] = [0u64; 64usize];
      (aM_copy0[0usize..64usize]).copy_from_slice(&resM[0usize..64usize]);
      let ctx_n: (&[u64], &[u64]) = ctx.split_at(0usize);
      amont_sqr(ctx_n.1, mu, aM_copy0, resM);
      crate::lowstar::ignore::ignore::<&[u64]>(ctx);
      sw = bit
    };
    let sw0: u64 = sw;
  ...
  if bBits.wrapping_rem(4u32) != 0u32
  {
    ...
    (resM[0usize..64usize]).copy_from_slice(&(table as &[u64])[0usize..64usize]);
  ...
  for i0 in 0u32..bBits.wrapping_div(4u32)
  {
    ...
    let bits_l: u64 = crate::hacl::bignum_base::Hacl_Bignum_Lib_bn_get_bits_u64(bLen, b, k, 4u32);
    crate::lowstar::ignore::ignore::<&[u64]>(table);
    (tmp0[0usize..64usize]).copy_from_slice(&(table as &[u64])[0usize..64usize]);
    for i1 in 0u32..15u32
    {
...
pub fn Hacl_Bignum4096_mod_inv_prime_vartime(n: &[u64], a: &[u64], res: &mut [u64]) -> bool
{
  ...
  if is_valid_m == 18446744073709551615u64
  {
    ...
    let c0: u64 =
        crate::lib_intrinsics::Lib_IntTypes_Intrinsics_sub_borrow_u64(0u64, n[0usize], 2u64, n2);
